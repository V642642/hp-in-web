  ...
  return (
    <div className='w-full flex items-center justify-center flex-col bg-white text-black'>
      ...
      <div className={`  w-full px-2 xl:w-5/12 lg:w-6/12 py-20 md:w-10/12 font-primary flex mt-[90px]  items-center justify-center flex-col gap-2`}>
              ...
              <p className="w-full text-center text-[15px]">Hey, Thanks for your interest in working with <span className="text-[#00a63f]">hiringplug™</span> 
<br/> We&apos;ll carefully evaluate your details and get in touch if it matches our open requirements. Meanwhile, you may wish to explore the below channels to stay updated on future openings & latest trends in HR Technology.</p>
